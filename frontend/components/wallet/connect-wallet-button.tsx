        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4">
          <div className="relative w-full max-w-lg overflow-hidden rounded-3xl border border-white/10 bg-[#070A1D]/95 p-8 text-white shadow-2xl">
            ...
            <p className="mt-4 text-sm text-white/70">
              Connect your wallet to continue with the private bridge. Choose between EVM (Sepolia) or Solana.
            </p>
            ...
            <div className="mt-6 grid gap-4">
              <button
                ...
                disabled={isBusy}
                className={cn(
                  "group relative overflow-hidden rounded-2xl border p-5 text-left transition cursor-pointer",
                  isEvmConnected
                    ? "border-cyan-400/60 bg-cyan-400/10 shadow-[0_20px_60px_-40px_rgba(56,226,255,0.8)]"
              ...
              >
                ...
                {isEvmConnected && account ? (
                  ...
                  <span className="mt-4 inline-flex text-[11px] font-semibold uppercase tracking-[0.2em] text-cyan-100/70">
                    Connect EVM
                  </span>
                )}
              </button>
              ...
              <button
                ...
                className={cn(
                  "group relative overflow-hidden rounded-2xl border p-5 text-left transition cursor-pointer",
                  isSolanaConnected
                    ? "border-violet-400/60 bg-violet-500/10 shadow-[0_20px_60px_-45px_rgba(139,92,246,0.8)]"
              ...
              >
                ...
                {isSolanaConnected && solanaAddress ? (
                  ...
                  <span className="mt-4 inline-flex text-[11px] font-semibold uppercase tracking-[0.2em] text-violet-100/70">
                    Connect Solana
                  </span>
                )}
              </button>
            ...
            <p className="mt-6 text-[11px] text-white/40">
              By continuing you accept the terms and confirm you understand the risks of beta networks.
            </p>
          </div>
        </div>
      ) : null}
