...
const DotMaterial = shaderMaterial(
  ...
  /* glsl */ `
    ...
    void main() {
      ...
      float combinedMask = max(screenMask * circleMaskFromCenter, 0.55);
      ...
      float dotSize = mix(0.24, 0.08, clamp(circleMaskCenter, 0.0, 1.0));

      float sdfDot = sdfCircle(gridUv, dotSize * (1.0 + scaleInfluence * 0.5));

      float smoothDot = smoothstep(0.1, -0.02, sdfDot);
