    ...
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <nav className="relative z-10 flex justify-between items-center px-8 py-6">
              ...
              {[...Array(8)].map((_, i) => (
                <div
                  ...
                  style={{
                    top: '50%',
                    left: '50%',
                    transform: `rotate(${i * 45}deg) translateY(-${16 - i * 1.5}px)`,
                    opacity: 1 - i * 0.1,
                  }}
                />
              ))}
        ...
        <div className="flex items-center gap-8">
          <a href="#docs" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 font-medium">
            Docs
          </a>
        ...
        <div className="max-w-6xl mx-auto text-center space-y-8">
          <div className="space-y-4 animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Experience <span className="text-white font-semibold">zero-knowledge privacy</span> meets instant liquidity.
              Transfer assets across chains with <span className="text-cyan-400 font-semibold">Arcium-grade encryption</span> —
              your bridge, your data, <span className="text-white font-semibold">completely private</span>.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-20 animate-fade-in-up animation-delay-400">
            <div className="group p-6 rounded-2xl border border-cyan-400/10 bg-black/40 backdrop-blur-sm hover:border-cyan-400/30 transition-all duration-500 hover:shadow-[0_0_30px_rgba(0,255,255,0.1)]">
              <div className="flex justify-center mb-4">
                <svg className="w-10 h-10 text-cyan-400 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/>
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-2 text-white">Military-Grade Privacy</h3>
              <p className="text-gray-400 leading-relaxed">
                Every transaction is encrypted end-to-end with <span className="text-cyan-400">Arcium's confidential computing</span>. No one sees your moves — not even us.
              </p>
            </div>
            ...
            <div className="group p-6 rounded-2xl border border-cyan-400/10 bg-black/40 backdrop-blur-sm hover:border-cyan-400/30 transition-all duration-500 hover:shadow-[0_0_30px_rgba(0,255,255,0.1)]">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Instant Settlement</h3>
              <p className="text-gray-400 leading-relaxed">
                Powered by <span className="text-cyan-400">Raydium's deep liquidity</span> and <span className="text-cyan-400">Triton's RPC infrastructure</span> for sub-second cross-chain transfers.
              </p>
            </div>
            ...
            <div className="group p-6 rounded-2xl border border-cyan-400/10 bg-black/40 backdrop-blur-sm hover:border-cyan-400/30 transition-all duration-500 hover:shadow-[0_0_30px_rgba(0,255,255,0.1)]">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Truly Trustless</h3>
              <p className="text-gray-400 leading-relaxed">
                No intermediaries, no custodians. <span className="text-cyan-400">Smart contracts</span> execute automatically. You hold the keys, you control the funds.
              </p>
            </div>
          </div>
          ...
          <div className="pt-16 animate-fade-in-up animation-delay-600">
            <div className="flex items-center justify-between max-w-4xl mx-auto opacity-60">
              <div className="flex items-center gap-8">
                <span className="text-sm text-gray-500 tracking-wider">POWERED BY</span>
              ...
              <div className="flex items-center gap-4">
                <a href="#" className="text-gray-500 hover:text-cyan-400 transition-colors duration-300 hover:scale-110 transform">
